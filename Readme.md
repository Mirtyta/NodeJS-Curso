# 📘 Repositorio de Aprendizaje: Node.js 🚀

## ¡Hola, equipo! 👋

Bienvenidos a este espacio colaborativo. He creado este repositorio con el objetivo de centralizar todo el material que vamos trabajando en clase. La idea es que tengamos un punto de referencia ordenado donde consultar los **cuestionarios** (una vez revisados con el profesor) y los **ejercicios prácticos** que vayamos resolviendo.

Este repositorio es para nosotros: para reforzar lo aprendido, sacarnos dudas y tener el código a mano cuando lo necesitemos. ¡Espero que les sirva muchísimo en este camino de convertirnos en expertos de Node!
...
* **`/Ejercicios`**: Todas las prácticas de las clases, organizadas para que puedan consultarlas cuando quieran.
   ...
   💬 [Ejercicio N° 4](./Ejercicios/Ejercicio-04/consigna.md) - Consigna | 💬 [Código](./Ejercicios/Ejercicio-04/miEjercicio.js) - Ejemplo 1 | 💬 [Código](./Ejercicios/Ejercicio-04/tiendaDePociones.js) - Ejemplo 2 | 💬 [Código](./Ejercicios/Ejercicio-04/veterinaria.js) - Ejemplo 3 |  
...
* 📺 **Clases Grabadas:** [Lista de reproducción YouTube](https://www.youtube.com/playlist?list=PLOV5DsaIdkkMpnaKHaByvfBLZvtdKOJyq)
* 👾 **Discord:** [Invitación (Primer ingreso)](https://discord.gg/feuHghk3v8) | [Ingreso al canal](https://discord.com/channels/1475495722575990805/1475495723117051924)
* *Nota: Recordá cambiar tu nombre en el servidor.* [(Tutorial)](https://drive.google.com/file/d/1ToNx0OXPkwItqtv9FYuligGYi79KT1jJ/view?usp=sharing)
* 📜 **[Pautas de convivencia](https://drive.google.com/file/d/1WS2Verl_RK2D-LlqLIA836hdHixVmT2A/view?usp=sharing)**
...
* **Duración:** 16 clases (un cuatrimestre intensivo).
* **Certificación:** Microcredencial oficial del Ministerio de Educación de la Ciudad de Buenos Aires.
* 📄 **[Plan de Estudios Completo (PDF)](https://drive.google.com/file/d/1mBFp2fSjL0OxOhHb4Hd03d0nrI85hhd8/view)**
...
3. **Ejecutar un archivo:**
   ...
   ```bash
   node nombre_carpeta/archivo.js
   ```
