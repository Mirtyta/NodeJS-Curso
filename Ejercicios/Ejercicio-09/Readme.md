...
Este proyecto es el **Ejercicio Práctico N° 9** y forma parte de mi repositorio de misiones de Node.js + Express. Debido a que las dependencias (`node_modules`) no se suben al repositorio por rendimiento y buenas prácticas, debés seguir estos pasos para hacerlo funcionar localmente.
...
Pero como en el mundo de la programación siempre hay un truco para todo, si alguien quiere únicamente la carpeta del Ejercicio 9 sin bajarse el resto, tiene dos opciones espectaculares.  
...
La persona entra a tu GitHub y se mete adentro de la carpeta ejercicio-09.  
Copia la URL que aparece en la barra de direcciones del navegador ([ejercicio-09](https://github.com/Mirtyta/NodeJS-Curso/tree/main/Ejercicios/ejercicio-09)) página web: [Downgit](downgit.github.io)  
...
```Bash
git remote add -f origin https://github.com/Mirtyta/NodeJS-Curso/tree/main/Ejercicios/ejercicio-09
```
...
```Bash
echo "ejercicio-09/" >> .git/info/sparse-checkout
```
...
Para probar este ejercicio 9 en tu entorno local, abrí tu terminal y ejecutá los siguientes comandos paso a paso:
